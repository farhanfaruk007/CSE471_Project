    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo" height="24"/> Infinity Store
                </h3>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-6 mt-4">
                    <address>
                        <strong>StockOptima</strong><br>
                        2/40 abcd road, Gulshan<br>
                        stockoptima@gmail.com
                    </address>
                </div>
